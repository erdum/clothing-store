...
<head>
    ...
    <title>Signup | Apparel UB365Inn</title>
  ...
  <div class="w-full max-w-md space-y-8">
    <div>
      ...
      <p class="mt-2 text-center text-sm text-gray-600">
        Or
        <a href="{{ route('login') }}" class="font-medium text-indigo-600 hover:text-indigo-500">login into existing account</a>
      </p>
    </div>
    <form class="mt-8 space-y-6" action="{{ route('signup_post') }}" method="POST">
        @csrf
