...
class Read extends Component
{
    ...
    protected $listeners = ['statusDeleted'];
    ...
    public function render()
    {
        ...
        return view('livewire.admin.status.read', [
            'statuss' => $data
        ])->layout('admin::layouts.app', ['title' => __(\Str::plural('Status')) ]);
    }
}
